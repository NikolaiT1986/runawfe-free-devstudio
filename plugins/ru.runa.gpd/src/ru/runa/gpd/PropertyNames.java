...
public interface PropertyNames {
    ...
    public static final String PROPERTY_TASKSTATE_EXECUTION_BUTTON = "executionButton";
    ...
    public static final String PROPERTY_DELEGABLE_EDIT_HANDLER = "delegableEditHandler";
